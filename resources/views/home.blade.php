    ...
    <div class="container bg-light p-5" style="border-radius: 20px;">
        <div class="row my-5">
            <div class="col-md-6 d-flex align-items-center">
                <div>
                    <h2>Selamat Datang di <br><b>Fans Page Tulus</b></h2>
                    <p class="text-secondary">Tempat Berkumpulnya Fans Tulus se-Indonesia, <br>Jangan ngaku TemanTulus kalo belum jadi Member</p>
